//var GreedyMesher = require("./mesher/GreedyMesher.js");
var CulledMesher = require("./mesher/CulledMesher.js");
...
function Chunk(x, z, chunkData) {
    ...
    var blockTextureManager = new BlockTextureManager();
    ...
    this.setBlock = function (block) {
        ...
        Vokkit.getClient().getSceneManager().reloadChunk(chunk);
    }

    this.toMesherData = function () {
        high = [16, 256, 16];
        low = [0, 0, 0];
            ...
            if (faces.length == 5) {
                ...
                if (geometry.vertices[faces[0]].x == geometry.vertices[faces[1]].x && geometry.vertices[faces[1]].x == geometry.vertices[faces[2]].x) {
                    ...
                    if (block.id == 0) {
                        ...
                        block = chunk.getBlock(blockPosition.set(minx - 1, miny, minz));
